...
// ----------------------------
//
// CustomRatingAccessibility.swift
//
// ----------------------------

/**

Functions for making CustomRating view accessible.

*/
struct CustomRatingAccessibility {
  /**
  
  Makes the view accesible by settings its label and using rating as value.
  
  */
  static func update(view: UIView, rating: Double, text: String?, settings: CustomRatingSettings) {
    view.isAccessibilityElement = true
    
    view.accessibilityTraits = settings.updateOnTouch ?
      UIAccessibilityTraitAdjustable :UIAccessibilityTraitNone
    
    var accessibilityLabel = CustomRatingLocalizedRating.ratingTranslation
  ...
  */
  static func accessibilityValue(view: UIView, rating: Double, settings: CustomRatingSettings) -> String {
    let accessibilityRating = CustomRating.displayedRatingFromPreciseRating(rating,
  ...
  */
  static func accessibilityIncrement(rating: Double, settings: CustomRatingSettings) -> Double {
  ...
  static func accessibilityDecrement(rating: Double, settings: CustomRatingSettings) -> Double {
    var increment: Double = 0
...
// ----------------------------
//
// CustomRatingDefaultSettings.swift
//
// ----------------------------
...
*/
struct CustomRatingDefaultSettings {
  init() {}
  ...
  */
  ...
  /// When `true` the star fill level is updated when user touches the CustomRating view. When `false` the CustomRating view only shows the rating and does not act as the input control.
...
class CustomRatingLayers {
  ...
  */
  class func createStarLayers(rating: Double, settings: CustomRatingSettings) -> [CALayer] {

    var ratingRemander = CustomRating.numberOfFilledStars(rating,
    ...
    for _ in (0..<settings.totalStars) {
      ...
      let fillLevel = CustomRating.starFillLevel(ratingRemainder: ratingRemander,
  ...
  - parameter settings: Star view settings.
  - returns: Layer that shows the star. The layer is displauyed in the CustomRating view.
  
  */
  class func createCompositeStarLayer(starFillLevel: Double, settings: CustomRatingSettings) -> CALayer {
  ...
  */
  class func createPartialStar(starFillLevel: Double, settings: CustomRatingSettings) -> CALayer {
  ...
  private class func createStarLayer(isFilled: Bool, settings: CustomRatingSettings) -> CALayer {
...
// ----------------------------
//
// CustomRatingLocalizedRating.swift
//
// ----------------------------
...
*/
struct CustomRatingLocalizedRating {
...
*/
public struct CustomRatingSettings {
  init() {}
  ...
  /// Border color of an empty star.
  public var borderColorEmpty = CustomRatingDefaultSettings.borderColorEmpty
  
  /// Width of the border for the empty star.
  public var borderWidthEmpty: Double = CustomRatingDefaultSettings.borderWidthEmpty

  /// Background color of an empty star.
  public var colorEmpty = CustomRatingDefaultSettings.colorEmpty
  
  /// Background color of a filled star.
  public var colorFilled = CustomRatingDefaultSettings.colorFilled
  ...
  */
  public var fillMode = CustomRatingDefaultSettings.fillMode
  
  /// Distance between stars.
  public var starMargin: Double = CustomRatingDefaultSettings.starMargin
  ...
  */
  public var starPoints: [CGPoint] = CustomRatingDefaultSettings.starPoints
  
  /// Size of a single star.
  public var starSize: Double = CustomRatingDefaultSettings.starSize
  
  /// The maximum number of stars to be shown.
  public var totalStars = CustomRatingDefaultSettings.totalStars
  ...
  /// Color of the text.
  public var textColor = CustomRatingDefaultSettings.textColor
  
  /// Font for the text.
  public var textFont = CustomRatingDefaultSettings.textFont
  
  /// Distance between the text and the stars.
  public var textMargin: Double = CustomRatingDefaultSettings.textMargin
  ...
  /// The lowest rating that user can set by touching the stars.
  public var minTouchRating: Double = CustomRatingDefaultSettings.minTouchRating
  
  /// When `true` the star fill level is updated when user touches the CustomRating view. When `false` the CustomRating view only shows the rating and does not act as the input control.
  public var updateOnTouch = CustomRatingDefaultSettings.updateOnTouch
}


// ----------------------------
//
// CustomRatingSize.swift
//
// ----------------------------
...
Helper class for calculating size for the CustomRating view.

*/
class CustomRatingSize {
  /**
  
  Calculates the size of the CustomRating view. It goes through all the star and text layers and makes size the view size is large enough to show all of them.
...
struct CustomRatingTouch {
  ...
  */
  static func touchRating(locationX: CGFloat, starsWidth: CGFloat, settings: CustomRatingSettings) -> Double {
    ...
    correctedRating = CustomRating.displayedRatingFromPreciseRating(correctedRating,
      fillMode: settings.fillMode, totalStars: settings.totalStars)
...
Example:
    ...
    CustomRatingView.text = "(123)"

Shows: ★★★★☆ (132)

*/
@IBDesignable public class CustomRatingView: UIView {
  ...
  */
  @IBInspectable public var rating: Double = CustomRatingDefaultSettings.rating {
    didSet {
      if oldValue != rating {
        update()
      }
  ...
  public var settings = CustomRatingSettings() {
    didSet {
      update()
    }
  }
  ...
  Initializes and returns a newly allocated CustomRating view object.
  ...
  */
  ...
  Initializes and returns a newly allocated CustomRating view object with the specified frame rectangle.
  ...
  */
  public func update() {
    ...
    var layers = CustomRatingLayers.createStarLayers(rating, settings: settings)
  ...
  */
  private func createTextLayer(text: String, layers: [CALayer]) -> CALayer {
    let textLayer = CustomRatingLayerHelper.createTextLayer(text,
      font: settings.textFont, color: settings.textColor)
    
    let starsSize = CustomRatingSize.calculateSizeToFitLayers(layers)
    
    CustomRatingText.position(textLayer, starsSize: starsSize, textMargin: settings.textMargin)
  ...
  */
  private func updateSize(layers: [CALayer]) {
    viewSize = CustomRatingSize.calculateSizeToFitLayers(layers)
  ...
  private func updateAccessibility() {
    CustomRatingAccessibility.update(self, rating: rating, text: text, settings: settings)
  }
  ...
  public override func accessibilityIncrement() {
    ...
    rating += CustomRatingAccessibility.accessibilityIncrement(rating, settings: settings)
  }
  ...
  public override func accessibilityDecrement() {
    ...
    rating -= CustomRatingAccessibility.accessibilityDecrement(rating, settings: settings)
  }
  
  // MARK: - Touch recognition
  
  /// Closure will be called when user touches the CustomRating view. The touch rating argument is passed to the closure.
  public var didTouchCustomRating: ((Double)->())?
  ...
  */
  func onDidTouch(locationX: CGFloat, starsWidth: CGFloat) {
    let calculatedTouchRating = CustomRatingTouch.touchRating(locationX, starsWidth: starsWidth,
      settings: settings)
    ...
    if calculatedTouchRating == previousRatingForDidTouchCallback {
      // Do not call didTouchCustomRating if rating has not changed
      return
    }
    
    didTouchCustomRating?(calculatedTouchRating)
  ...
  var widthOfStars: CGFloat {
    if let sublayers = self.layer.sublayers where settings.totalStars <= sublayers.count {
      ...
      return CustomRatingSize.calculateSizeToFitLayers(starLayers).width
    }
  ...
  override public func pointInside(point: CGPoint, withEvent event: UIEvent?) -> Bool {
    let oprimizedBounds = CustomRatingTouchTarget.optimize(bounds)
  ...
  @IBInspectable var totalStars: Int = CustomRatingDefaultSettings.totalStars {
    didSet {
      settings.totalStars = totalStars
    }
  }
  
  @IBInspectable var starSize: Double = CustomRatingDefaultSettings.starSize {
    didSet {
      settings.starSize = starSize
    }
  }
  
  @IBInspectable var colorFilled: UIColor = CustomRatingDefaultSettings.colorFilled {
    didSet {
      settings.colorFilled = colorFilled
    }
  }
  
  @IBInspectable var colorEmpty: UIColor = CustomRatingDefaultSettings.colorEmpty {
    didSet {
      settings.colorEmpty = colorEmpty
    }
  }
  
  @IBInspectable var borderColorEmpty: UIColor = CustomRatingDefaultSettings.borderColorEmpty {
    didSet {
      settings.borderColorEmpty = borderColorEmpty
    }
  }
  
  @IBInspectable var borderWidthEmpty: Double = CustomRatingDefaultSettings.borderWidthEmpty {
    didSet {
      settings.borderWidthEmpty = borderWidthEmpty
    }
  }
  
  @IBInspectable var starMargin: Double = CustomRatingDefaultSettings.starMargin {
    didSet {
      settings.starMargin = starMargin
    }
  }
  
  @IBInspectable var fillMode: Int = CustomRatingDefaultSettings.fillMode.rawValue {
    didSet {
      settings.fillMode = StarFillMode(rawValue: fillMode) ?? CustomRatingDefaultSettings.fillMode
    }
  }
  
  @IBInspectable var textSize: Double = CustomRatingDefaultSettings.textSize {
    didSet {
      settings.textFont = settings.textFont.fontWithSize(CGFloat(textSize))
    }
  }
  
  @IBInspectable var textMargin: Double = CustomRatingDefaultSettings.textMargin {
    didSet {
      settings.textMargin = textMargin
    }
  }
  
  @IBInspectable var textColor: UIColor = CustomRatingDefaultSettings.textColor {
    didSet {
      settings.textColor = textColor
    }
  }
  
  @IBInspectable var updateOnTouch: Bool = CustomRatingDefaultSettings.updateOnTouch {
    didSet {
      settings.updateOnTouch = updateOnTouch
    }
  }
  
  @IBInspectable var minTouchRating: Double = CustomRatingDefaultSettings.minTouchRating {
    didSet {
...
*/
struct CustomRatingTouchTarget {
