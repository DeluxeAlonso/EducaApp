...
- (UIImage *)trackBackgroundImage
{
    ...
    {
      UIImage *image = [UIImage imageNamed: @"SliderDefaultTrackBackground"];
...
- (UIImage *)trackImage
{
    if(_trackImage==nil)
    {
      UIImage *image = [UIImage imageNamed: @"SliderDefaultTrack"];
      image = [image resizableImageWithCapInsets:UIEdgeInsetsMake(0.0, 2.0, 0.0, 2.0)];
...
- (UIImage *)lowerHandleImageNormal
{
    ...
    {
      UIImage *image = [UIImage imageNamed: @"SliderDefaultHandle"];
